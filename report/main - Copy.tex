...
\newcommand{\reporttitle}{Understanding Opinion Dynamics in Social Networks}
...
\end{minipage}
\end{center}
\captionof{figure}{Generated Graphs Before and After Addressing the Saturation Issue, 250 Iterations Each}
\end{figure}
...
\end{minipage}
\end{center}
\captionof{figure}{CORA performance by model}
\end{figure}
...
\end{minipage}
\end{center}
\captionof{figure}{Two generated graphs after 350 iterations}
\end{figure}
...
\captionof{subfigure}{True classes visualized on our system's embeddings}
\end{minipage}%
\hfill
\begin{minipage}{0.45\linewidth}
...
\end{minipage}%
\end{center}
\captionof{figure}{Embedding vs adjacency stability on two runs}
\end{figure}
